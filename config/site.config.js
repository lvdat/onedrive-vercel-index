...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'lvdat@levandat.tech',
  ...
  title: "CICT IT Club Drive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/CICTWeb',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/lvdat/onedrive-vercel-index',
    },
  ],
